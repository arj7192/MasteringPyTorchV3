...
**Re-baseline date:** 17 May 2026 (updated 20 May 2026 with Packt's editorial decisions; **honest schedule re-baseline 3 Aug 2026**)
...
- Editorial decisions locked 20 May 2026 (Responsible AI distributed; NST dropped; Llama 3 headline).
- **As of 3 Aug 2026:** planning + companion-repo scaffolding are done; Wave 1 mechanical prep (notebooks remapped, API modernizations, planned removals, Ch 1 prose drafts) is in GitHub. **No first-draft chapter manuscripts have been delivered to Packt yet.** Wave 1 (12 Jun) and Wave 2 (24 Jul) dates were missed.
- See `_planning/STATUS.md` for the live chapter board.
...
- **Print target (Aug 2026 re-baseline):** **May–Jun 2027**. Feb 2027 is no longer realistic without a hard scope cut.
- **Backward solve:** production needs ~8 weeks → all final drafts by **late Mar 2027** → all first drafts by **mid-Feb 2027**. Net authoring window from today: ~6.5 months.
- **Authoring capacity:** sustainable **10–14 focused hours/week** (honest vs Nativ load), not the earlier 18–22 aspiration. Cadence: ~1 chapter every 1.5–2 weeks averaged.
...
### Wave 1 : Refresh chapters - first drafts by **Fri 29 Aug 2026**
- Ch 1: Overview of DL with PyTorch - refresh + PyTorch 2.x section + Responsible AI primer *(prose drafts + compile demo already in repo)*
- Ch 2: Deep CNN Architectures - code refresh on PyTorch 2.x + ConvNeXt v2 *(weights-API modernized in repo)*
- Ch 3: Deep Recurrent Models - code refresh, torchtext → HF Datasets migration
- Ch 15: Rapid Prototyping - refresh *(poutyne already removed from repo)*
- Ch 17: Explainable AI - Captum refresh

### Wave 2 : Heavy-refactor chapters - first drafts by **Fri 10 Oct 2026**
- Ch 4: Transformers (+ Vision Transformers heavy new section) *(RandWireNN already removed from repo)*
...
### Wave 3 : Net-new and big-bet chapters - first drafts by **Fri 12 Dec 2026**
- Ch 5: Advanced Multimodal Models (mostly new)
- Ch 7: Music and Text Generation (Llama 3, MusicGen, speculative decoding **+ text watermarking**) *(GPT-3 OpenAI notebook already removed)*
...
### Wave 4 : Tail chapters - first drafts by **Fri 13 Feb 2027**
...
- All final drafts delivered: **Fri 27 Mar 2027**
- Copy-edit, typesetting, proof, index: Apr–May 2027
